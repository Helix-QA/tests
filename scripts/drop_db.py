...
# ================== CONFIG ==================
RAC_PATH = r"C:\Program Files\1cv8\8.5.1150\bin\rac.exe"
...
if __name__ == "__main__":
    ...
    # Убираем COM entirely
    print("COMConnector пропущен — используем RAC + PostgreSQL")

    # RAC drop (если включить, можно раскомментировать)
