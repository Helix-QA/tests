...
Сценарий: Врач. Создание плана лечения
	...
	*Заполнение данными
		...
		И я нажимаю на кнопку с именем 'К_ВыборСтраницы_С_ТекущаяЗубнаяФормула'
		И я нажимаю на кнопку с именем 'К_ВыборСтраницы_С_БудущаяЗубнаяФормула'
...
Сценарий: Врач. Создание приема
	...
	*Проверка открытий каждого окна
