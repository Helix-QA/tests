...
//Создаёт дату на 1 день вперёд - 23.10.2025
	Дано Я запоминаю значение выражения 'Формат(ТекущаяДата() + 86400, "ДЛФ=Д")' в переменную "$$ЦифроваяДатаНаДень$$"
...
//Создаёт дату - на день больше
	Дано Я запоминаю значение выражения 'Формат(ТекущаяДата()+86400, "ДЛФ=Д")' в переменную "$$ОдниДеньБольше$$"

//Создаёт дату - на день меньше
	Дано Я запоминаю значение выражения 'Формат(ТекущаяДата()-86400, "ДЛФ=Д")' в переменную "$$ОдниДеньМеньше$$"

//Создаёт дату - на три дня больше
	Дано Я запоминаю значение выражения 'Формат(ТекущаяДата()+259200, "ДЛФ=Д")' в переменную "$$триДняБольше$$"

//Создаёт дату - на три дня больше
	Дано Я запоминаю значение выражения 'Формат(ТекущаяДата()-259200, "ДЛФ=Д")' в переменную "$$ТриДняМеньше$$"
