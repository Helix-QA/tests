...
Сценарий: Я создаю врача_2
	...
	Дано я запоминаю значение выражения '"Сотрудник_2" + Формат($Сотрудник_2$, "ЧГ=0")' в переменную "$$Сотрудник_2$$"
	Дано Я открываю основную форму справочника "Сотрудники"
...
Сценарий: Я создаю подарочный сертификат
*Создание сертификата	
	...
	И в поле с именем 'Номинал' я ввожу текст "5 000,00"
	И я перехожу к следующему реквизиту
	И я устанавливаю флаг с именем 'ВестиСерийныеНомера'
	И я устанавливаю флаг с именем 'СертификатМногоразовоеИспользование'
	И я устанавливаю флаг с именем 'ЭтоИменнойСертификат'
	Когда открылось окно "Номенклатура (создание) *"
	И я нажимаю на гиперссылку с именем 'ПерейтиНаСерииСертификатов'
	Тогда открылось окно "1С:Предприятие"
	И я нажимаю на кнопку с именем 'Button0'
	*Создание серии сертификата
		И я нажимаю на кнопку с именем 'Создать'
		И Я запоминаю случайное число в переменную "СерияСертификата"
		Дано я запоминаю значение выражения '"СерияСертификата" + Формат($СерияСертификата$, "ЧГ=0")' в переменную "$$СерияСертификата$$"
		И в поле с именем "Наименование" я ввожу текст "$$СерияСертификата$$"		
		И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
	И В текущем окне я нажимаю кнопку командного интерфейса "Основное"
	И я нажимаю на кнопку с именем 'ДобавитьЦенуНоменклатуры'
	Тогда открылось окно "Цена номенклатуры (создание)"
	И в поле с именем 'Цена' я ввожу текст "5 000,00"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

Сценарий: Я создаю материал.
	И Я запоминаю случайное число в переменную "Материал"
	Дано я запоминаю значение выражения '"Материал" + Формат($Материал$, "ЧГ=0")' в переменную "$$Материал$$"
	Дано Я открываю основную форму справочника "Номенклатура"
	...
	Тогда открылось окно "1С:Предприятие"
	И я нажимаю на кнопку с именем 'Button0'
	И я активизирую окно 'Цена номенклатуры (создание)'		
...
Сценарий: Я создаю имущество.
	...
	И я нажимаю на кнопку с именем 'Button0'
	И я активизирую окно 'Цена номенклатуры (создание)'		
	И в поле с именем 'Цена' я ввожу текст "350,00"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
