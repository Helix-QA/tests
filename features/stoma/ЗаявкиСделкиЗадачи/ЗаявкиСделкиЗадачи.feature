...
Сценарий: Проверка обращения
	...
	*Заполнение полей "Фамилия"
		...
		И Я запоминаю значение выражения '"Фамилия1" + Формат($Фамилия1$, "ЧГ=0")' в переменную "$$Фамилия1$$"
		И в поле с именем 'Фамилия' я ввожу текст "$$Фамилия1$$"
						
	*Заполнение полей "Имя"
		И я запоминаю случайное число в диапазоне от "1000" до "9999" в переменную "Имя1"
		И Я запоминаю значение выражения '"Имя1" + Формат($Имя1$, "ЧГ=0")' в переменную "$$Имя1$$"
		И в поле с именем 'Имя' я ввожу текст "$$Имя1$$"

	*Заполнение полей "Отчество"
		И я запоминаю случайное число в диапазоне от "1000" до "9999" в переменную "Отчество1"
		И Я запоминаю значение выражения '"Отчество1" + Формат($Отчество1$, "ЧГ=0")' в переменную "$$Отчество1$$"
		И в поле с именем 'Отчество' я ввожу текст "$$Отчество1$$"

	*Заполнение полей "Дата рождения"
		И в поле с именем 'ДатаРождения' я ввожу текст "10.10.2000"

	*Заполнение полей "Телефон"
		И Я запоминаю случайное число в переменную "$$НомерТелефона1$$"
		И в поле с именем 'ПредставлениеКИ_0' я ввожу текст "$$НомерТелефона1$$"
		И я нажимаю кнопку выбора у поля с именем 'ПредставлениеКИ_0'
		И я нажимаю на кнопку с именем 'КомандаОК'
		И в поле с именем 'КомментарийКИ_0' я ввожу текст "Телефон"
	...
	*Заполнение полей "Email"
		И Я запоминаю значение выражения 'Формат($$НомерТелефона1$$, "ЧГ=0") + "@mail.ru"' в переменную "$$Mail1$$"
		И я нажимаю на кнопку с именем 'КнопкаДобавитьКонтактнуюИнформацию'
		И в меню формы я выбираю 'Email'
		И в поле с именем 'ПредставлениеКИ_2' я ввожу текст "$$Mail1$$"
		И в поле с именем 'КомментарийКИ_2' я ввожу текст "Email"
				
	*Заполнение полей "Адрес фактический"
		И я нажимаю на кнопку с именем 'КнопкаДобавитьКонтактнуюИнформацию'
		И в меню формы я выбираю 'Адрес фактический'
		И я нажимаю кнопку выбора у поля с именем 'ПредставлениеКИ_3'
		И в поле с именем 'НаселенныйПункт' я ввожу текст "4"
		И в поле с именем 'Улица' я ввожу текст "4"
		И в поле с именем 'Дом' я ввожу текст "4"
		И в поле с именем 'Строение' я ввожу текст "4"
		И в поле с именем 'Помещение' я ввожу текст "4"
		И в поле с именем 'Индекс' я ввожу текст "4"
		И я нажимаю на кнопку с именем 'ФормаКомандаОК'

	*Заполнение полей "Социальная сеть"
		И Я запоминаю значение выражения 'Формат($$НомерТелефона1$$, "ЧГ=0") + ".ru"' в переменную "$$СоциальнаяCеть1$$"
		И я нажимаю на кнопку с именем 'КнопкаДобавитьКонтактнуюИнформацию'
		И в меню формы я выбираю 'Социальная сеть'
		И в поле с именем 'ПредставлениеКИ_4' я ввожу текст "$$СоциальнаяCеть1$$"
		И в поле с именем 'КомментарийКИ_4' я ввожу текст "Социальная сеть"				

	*Заполнение полей "Куратор"
		И элемент формы с именем 'ОсновнойМенеджер' стал равен "Админ"
				
	*Заполнение полей "Иточник"
	...
	*Заполнение полей "Пациент"	
		И в поле с именем 'ИсточникИнформацииЗначение' я ввожу текст "$$Пациент$$"
		И из выпадающего списка с именем 'ИсточникИнформацииЗначение' я выбираю "$$Пациент$$"

	*Заполнение полей "Способ связи"
		И я нажимаю кнопку выбора у поля с именем 'КаналПривлечения'
		И в таблице 'Список' я перехожу к строке:
			| "Наименование"    |
			| "Входящий звонок" |								

	*Заполнение полей "Комментарий"
		И я нажимаю на кнопку с именем 'КнопкаВыбрать'
		И в поле с именем 'Комментарий' я ввожу текст "Проверка обращения"
	
	*Заполнение полей "Направление"
		И я нажимаю на кнопку создать поля с именем 'Направление'
		И в поле с именем 'Наименование' я ввожу текст "$$НомерТелефона1$$"
		И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
						
	*Заполнение полей "Категория"
		И я нажимаю на кнопку создать поля с именем 'Категория'
		И в поле с именем 'Наименование' я ввожу текст "$$НомерТелефона1$$"
		И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

	*Сохранение и открытие обращения
		И я нажимаю на кнопку с именем 'ФормаКнопкаЗаписатьИЗакрыть'

		И в таблице 'Список' я перехожу к строке:
			| 'Статус'          | 'ФИО'                                 | 'Куратор' | 'Источник (Source)'           | 'Способ связи'    | 'Кем создано' | 'Комментарий'        |
			| 'Новое обращение' | '$$Фамилия1$$ $$Имя1$$ $$Отчество1$$' | 'Админ'   | 'Другой пациент стоматологии' | 'Входящий звонок' | 'Админ'       | 'Проверка обращения' |
		И в таблице 'Список' я выбираю текущую строку						

	*Заполнение полей "Задача"
		И я нажимаю на кнопку с именем 'ВзаимодействиеЗадачаВыбрать'
		И в меню формы я выбираю 'Звонок'
		И в поле с именем 'ВзаимодействиеЗадачаТекст' я ввожу текст "Проверка звонок"
		И я нажимаю на кнопку с именем 'ВзаимодействиеЗадачаСоздать'
		И я нажимаю на кнопку с именем 'ВзаимодействиеЗадачаВыбрать'
		И в меню формы я выбираю 'Прочее'
		И в поле с именем 'ВзаимодействиеЗадачаТекст' я ввожу текст "Проверка прочее"
	...
	*Проверка поля "Задача"
		Тогда элемент формы с именем 'ИсторияВзаимодействия' стал равен по шаблону
			|'    	    		<div class=\"text-message\"><input style=\"margin:0 2px 0 0; width:12px; height:12px;\" title=\"Отметить как выполнено\" type=\"checkbox\" class=\"executetask\" name=\"Взаимодействие\" id=\"*\"><span class=\"interaction\" style=\"color: #000\"><img src=\"data:image/svg+xml;base64,\" width=\"12\" height=\"12\"> Позвонить пациенту - Проверка звонок</span></div>'|
		Тогда элемент формы с именем 'ИсторияВзаимодействия' стал равен по шаблону
			|'    	    		<div class=\"text-message\"><input style=\"margin:0 2px 0 0; width:12px; height:12px;\" title=\"Отметить как выполнено\" type=\"checkbox\" class=\"executetask\" name=\"Взаимодействие\" id=\"*\"><span class=\"interaction\" style=\"color: #000\"><img src=\"data:image/svg+xml;base64,\" width=\"12\" height=\"12\"> Прочее - Проверка прочее</span></div>'|

	*Заполнение полей "Заметка"
		И я нажимаю на кнопку с именем 'СоздатьЗаметку'
		И в поле с именем 'ТекстЗаметки' я ввожу текст "Проверка заметки"
		И я нажимаю на кнопку с именем 'КнопкаСохранитьИзменения'
				
	*Проверка поля "Заметка"
		Тогда элемент формы с именем 'ИсторияВзаимодействия' стал равен по шаблону
			|'           		<div class=\"text-message\" style=\"color: #000000;\">Проверка заметки</div>  '|
