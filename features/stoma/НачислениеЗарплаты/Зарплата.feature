...
*Ручная настройка регистра т.к ограничили доступ к настройкам ЖР по тикету - 849400.
	И я удаляю все записи РегистрСведений "НастройкиИнтерфейсов"
	Дано Я открываю основную форму списка регистра сведений "НастройкиИнтерфейсов"
	И я нажимаю на кнопку с именем 'Создать'
	Тогда открылось окно 'Настройки интерфейсов (создание)'		
	И в поле с именем 'Настройка' я ввожу текст "Отображение фильтров"
	И из выпадающего списка с именем 'Настройка' я выбираю "Отображение фильтров"
	И из выпадающего списка с именем 'СтруктурнаяЕдиница' я выбираю точное значение "Центр Стоматологической Имплантологии"
	Когда открылось окно "Настройки интерфейсов (создание) *"
	И в поле с именем 'Пользователь' я ввожу текст "$$Сотрудник$$"
	И из выпадающего списка с именем 'Пользователь' я выбираю "$$Сотрудник$$"
	И я нажимаю кнопку выбора у поля с именем 'Значение'
	Тогда открылось окно "Выбор типа данных"
	И в таблице '' я перехожу к строке:
		| ""                               |
		| "Время начала - время окончания" |
	И я нажимаю на кнопку "ОК"
	И в поле с именем 'Значение' я ввожу текст "По горизонтали"
	Когда открылось окно "Настройки интерфейсов (создание) *"
	И из выпадающего списка с именем 'Значение' я выбираю точное значение "По горизонтали"
	И из выпадающего списка с именем 'Значение' я выбираю по строке "По горизонтали"
...
//	Тогда открылось окно "Настройки журнала предварительной записи"
...
//	Тогда открылось окно 'Начальная страница'
	...
	И я открываю основную форму документа "Событие"
//	И клик по координатам "800" "480"
	И из выпадающего списка с именем 'УслугиДатаНачалаПолем' я выбираю "00:30"
	...
	И из выпадающего списка с именем 'УслугиДатаНачалаПолем' я выбираю "00:30"
	И я нажимаю на кнопку с именем 'ФормаКнопкаПровестиИЗакрыть'
	Тогда открылось окно "Способы связи"
...
*Возвращение к администратору
	И я закрываю сеанс текущего клиента тестирования
	И я жду когда закроется TestClient "Врач" в течение 10 секунд
...
Сценарий: Создание начисления - Процент от оказанных оформленных услуг/товаров сотрудником в качестве куратора.
*Создание начисления - Процент от оказанных оформленных услуг/товаров сотрудником в качестве куратора.					
	Дано Я открываю навигационную ссылку "$$СсылкаВрача$$"
	И В текущем окне я нажимаю кнопку командного интерфейса "Начисления и удержания"
	И в таблице 'Дерево' я перехожу к строке:
		| "Наименование" |
	...
	И из выпадающего списка с именем 'ТипНачисленияУдержания' я выбираю точное значение "Процент"
	И из выпадающего списка с именем 'УчитываяТолькоОплаченныеПродажи' я выбираю точное значение "от оказанных"
	И из выпадающего списка с именем 'ОтПродаж' я выбираю точное значение "услуг/товаров сотрудника в качестве куратора"
	И из выпадающего списка с именем 'УсловиеСумма' я выбираю точное значение "от всей суммы"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

*Добавление куратора в карточку пациента.
	Дано Я открываю навигационную ссылку "$$СсылкаПациента$$"
	И в поле с именем 'Куратор' я ввожу текст "$$Сотрудник$$"
	И из выпадающего списка с именем 'Куратор' я выбираю "$$Сотрудник$$"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
			
*Создание приёма из карточки пациента.
	Дано Я открываю навигационную ссылку "$$СсылкаПациента$$"
	...
	И элемент формы 'Куратор' стал равен '$$Сотрудник$$'	
	И Я оплатил прием		
...
*Создание нового начисления зарплаты.
	...
	И таблица 'РасчетЗарплаты' стала равной:
		| 'N' | 'К'   | 'Персонал'      | 'Начисление (удержание)'                                                                               | 'Период с'           | 'Период по'         | 'Часов план' | 'Дней план' | 'Часов факт' | 'Дней факт' | 'База'   | 'Размер' | 'Сумма'  | 'Описание'                                                                                                                                                                                     |
		| '1' | 'Нет' | '$$Сотрудник$$' | 'Процент от оказанных услуг/товаров сотрудника в качестве куратора, за каждый час сверх менее 0 руб. ' | '$НачалоМесяцаДата$' | '$КонецМесяцаДата$' | ''           | ''          | ''           | ''          | '257,50' | '100,00' | '257,50' | 'Процент от оказанных услуг/товаров сотрудника в качестве куратора в размере 100 % от всей суммы, не вычитая стоимость использованных материалов от суммы , за каждый час сверх менее 0 руб. ' |
	И я нажимаю на кнопку с именем '_Затраты'
	И таблица 'Затраты' стала равной по шаблону:
		| 'N' | 'Дата'                                     | 'Документ'                                                             | 'Персонал'      | 'Вид начисления'                                                                                       | 'Пациент'     | 'Номенклатура' | 'План' | 'Факт' | 'База'   | 'Размер (%, сумма)' | 'Сумма'  |
		| '1' | '{Формат(ТекущаяДата(), "ДФ=дд.ММ.гггг")}' | 'Приём * начат в *:*, {Формат(ТекущаяДата(), "ДЛФ=ДД")} (не проведен)' | '$$Сотрудник$$' | 'Процент от оказанных услуг/товаров сотрудника в качестве куратора, за каждый час сверх менее 0 руб. ' | '$$Пациент$$' | '$$Услуга$$'   | ''     | ''     | '257,50' | '100,00'            | '257,50' |
...
*Создание нового начисления зарплаты.
	...
	И таблица 'Затраты' содержит строки по шаблону:
		| 'N' | 'Дата'                                     | 'Документ'                      | 'Персонал'      | 'Вид начисления'                                                                                       | 'Пациент'     | 'Номенклатура' | 'План' | 'Факт' | 'База'   | 'Размер (%, сумма)' | 'Сумма'   |
		| '*' | '{Формат(ТекущаяДата(), "ДФ=дд.ММ.гггг")}' | 'Приём * начат в *:*, * * *. *' | '$$Сотрудник$$' | 'Процент от оказанных услуг/товаров сотрудника в качестве куратора, за каждый час сверх менее 0 руб. ' | '$$Пациент$$' | '$$Услуга$$'   | ''     | ''     | '257,50' | '100,00'            | '257,50'  |
		| '*' | '$КонецМесяцаДата$'                        | ''                              | '$$Сотрудник$$' | 'Удержание в размере 150 руб. '                                                                        | ''            | ''             | ''     | ''     | '1,00'   | '-150,00'           | '-150,00' |
...
Сценарий: Закрытие клиента текущего и подключение Админа
	И я закрываю сеанс текущего клиента тестирования
	Дано я подключаю TestClient "Админ" логин "Админ" пароль ""


Сценарий: Проверка по тикету - 827282
*Определение какой "Сегодня" и "Вчера" день недели.
#Код исходя из ТекущейДаты определяет через формат dddd какой это день недели, и потом полученный результат
#делает так чтобы первая буква была заглавной
	И я выполняю код встроенного языка
		"""bsl
			ТекДата = ТекущаяДата();
			ДеньСегодня = ВРег(Лев(Формат(ТекДата, "ДФ=dddd"),1)) + Сред(Формат(ТекДата, "ДФ=dddd"),2);
			ДеньВчера   = ВРег(Лев(Формат(ТекДата - 86400, "ДФ=dddd"),1)) + Сред(Формат(ТекДата - 86400, "ДФ=dddd"),2);
			Контекст.Вставить("СегодняДеньНедели", ДеньСегодня);
			Контекст.Вставить("ВчераДеньНедели",   ДеньВчера);
		"""

*Проверка с выбранным днём недели.
	И я удаляю объекты "Справочники.НачисленияИУдержанияСотрудников" без контроля ссылок
	Дано Я открываю навигационную ссылку "$$СсылкаВрача$$"
	И В текущем окне я нажимаю кнопку командного интерфейса "Начисления и удержания"
	И я нажимаю на кнопку с именем 'Создать'	
	...
	И из выпадающего списка с именем 'УсловиеПродажиТариф' я выбираю точное значение "без условий"
	И в поле с именем 'Размер' я ввожу текст "100,00"
*Выбираю текущий день недели.	
	И в таблице 'ФильтрПоВремени' я перехожу к строке:
		| "День недели"         | "Используется" |
		| "$СегодняДеньНедели$" | "Нет"          |
	И в таблице 'ФильтрПоВремени' я активизирую поле с именем 'ФильтрПоВремениИспользуется'
	И в таблице 'ФильтрПоВремени' я устанавливаю флаг с именем 'ФильтрПоВремениИспользуется'
	И в таблице 'ФильтрПоВремени' я завершаю редактирование строки
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
...
*Создание табеля учета рабочего времени.
	...
	И в таблице "Список" я перехожу к строке по шаблону:
		...
		| '*$$Сотрудник$$*' |
	И в таблице "Список" я выбираю текущую строку
	*Выставляю график работы за "Сегодня".
		И Я запоминаю значение выражения 'Формат(ТекущаяДата(), "ДФ=д")' в переменную "ТекущийДень"
		И в таблице 'ДниРаботы' я активизирую поле с именем 'ТаблицаГрафикаДень$ТекущийДень$'
		И в таблице 'ДниРаботы' я выбираю текущую строку
		И в таблице 'ДниРаботы' в поле с именем 'ТаблицаГрафикаДень$ТекущийДень$' я ввожу текст "23:00"
		И в таблице 'ДниРаботы' я завершаю редактирование строки
	*Выставляю график работы за "Вчера".
		И Я запоминаю значение выражения 'Формат(ТекущаяДата()-84600, "ДФ=д")' в переменную "Вчера"
		И в таблице 'ДниРаботы' я активизирую поле с именем 'ТаблицаГрафикаДень$Вчера$'
		И в таблице 'ДниРаботы' я выбираю текущую строку
		И в таблице 'ДниРаботы' в поле с именем 'ТаблицаГрафикаДень$Вчера$' я ввожу текст "23:00"
		И в таблице 'ДниРаботы' я завершаю редактирование строки
	И я нажимаю на кнопку с именем 'ФормаКнопкаПровестиИЗакрыть'
...
*Создание начисления зарплаты.
	...
	И таблица 'РасчетЗарплаты' стала равной:
		| 'N' | 'К'   | 'Персонал'      | 'Начисление (удержание)' | 'Период с'           | 'Период по'         | 'Часов план' | 'Дней план' | 'Часов факт' | 'Дней факт' | 'База' | 'Размер' | 'Сумма'    | 'Описание'                         |
		| '1' | 'Нет' | '$$Сотрудник$$' | 'Тариф за час'           | '$НачалоМесяцаДата$' | '$КонецМесяцаДата$' | ''           | ''          | '23,00'      | ''          | ''     | '100,00' | '2 300,00' | 'Тариф за час в размере 100 руб. ' |
	И у элемента формы с именем 'СуммаДокумента1' текст редактирования стал равен "2 300,00"
	И я нажимаю на кнопку с именем '_Затраты'
	Тогда таблица 'Затраты' стала равной:
		| 'N' | 'Дата'                                     | 'Документ' | 'Персонал'      | 'Вид начисления' | 'Пациент' | 'Номенклатура' | 'План' | 'Факт'  | 'База' | 'Размер (%, сумма)' | 'Сумма'    |
		| '1' | '{Формат(ТекущаяДата(), "ДФ=дд.ММ.гггг")}' | ''         | '$$Сотрудник$$' | 'Тариф за час'   | ''        | ''             | ''     | '23,00' | ''     | '100,00'            | '2 300,00' |
	И я закрываю все окна клиентского приложения
	
*Добавление в тариф "Вчера".
	Дано Я открываю навигационную ссылку "$$СсылкаВрача$$"
	И В текущем окне я нажимаю кнопку командного интерфейса "Начисления и удержания"
	И в таблице 'Дерево' я перехожу к строке:
		| "Наименование" |
		| "Тариф за час" |
	И в таблице 'Дерево' я выбираю текущую строку	
	Тогда открылось окно 'Тариф за час (Начисление или удержание)'	
	И в таблице 'ФильтрПоВремени' я перехожу к строке:
		| "День недели"       | "Используется" |
		| "$ВчераДеньНедели$" | "Нет"          |
	И в таблице 'ФильтрПоВремени' я активизирую поле с именем 'ФильтрПоВремениИспользуется'
...
# Вчера
	...
	И таблица 'РасчетЗарплаты' стала равной:
		| 'N' | 'К'   | 'Персонал'      | 'Начисление (удержание)' | 'Период с'           | 'Период по'         | 'Часов план' | 'Дней план' | 'Часов факт' | 'Дней факт' | 'База' | 'Размер' | 'Сумма'    | 'Описание'                         |
		| '1' | 'Нет' | '$$Сотрудник$$' | 'Тариф за час'           | '$НачалоМесяцаДата$' | '$КонецМесяцаДата$' | ''           | ''          | '46,00'      | ''          | ''     | '100,00' | '4 600,00' | 'Тариф за час в размере 100 руб. ' |
	И у элемента формы с именем 'СуммаДокумента1' текст редактирования стал равен "4 600,00"
	И я нажимаю на кнопку с именем '_Затраты'
	И таблица 'Затраты' стала равной:
		| 'N' | 'Дата'      | 'Документ' | 'Персонал'      | 'Вид начисления' | 'Пациент' | 'Номенклатура' | 'План' | 'Факт'  | 'База' | 'Размер (%, сумма)' | 'Сумма'    |
		| '1' | '$Вчера$'   | ''         | '$$Сотрудник$$' | 'Тариф за час'   | ''        | ''             | ''     | '23,00' | ''     | '100,00'            | '2 300,00' |
		| '2' | '$Сегодня$' | ''         | '$$Сотрудник$$' | 'Тариф за час'   | ''        | ''             | ''     | '23,00' | ''     | '100,00'            | '2 300,00' |