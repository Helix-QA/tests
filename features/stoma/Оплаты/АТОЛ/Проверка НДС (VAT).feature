...
//	И я запоминаю строку "72.99" в переменную 'VATAmount'
//	И я запоминаю строку "15" в переменную 'СтавкаНДС'
//	И я запоминаю строку "72,99" в переменную 'СуммаНДС'
//
//	И Я проверяю xml реализации НДС (VAT)
//	И Я проверяю xml возврата реализации НДС (VAT)
//	И Я проверяю xml с приорететом номенклатуры реализации НДС (VAT)

Сценарий: В чеке "VATRate=16"
	И Я открываю основную форму списка справочника "Организации"
	И в таблице 'Список' я выбираю текущую строку
...
* Ввод переменных для проверки xml
	...
	И я запоминаю строку "77.19" в переменную 'VATAmount'
	И я запоминаю строку "16" в переменную 'СтавкаНДС'
	И я запоминаю строку "77,19" в переменную 'СуммаНДС'
...
* Ввод переменных для проверки xml
	...
	И я запоминаю строку "100.91" в переменную 'VATAmount'
	И я запоминаю строку "22" в переменную 'СтавкаНДС'
	И я запоминаю строку "100,91" в переменную 'СуммаНДС'
	И я запоминаю строку "10" в переменную '{"VATRate_Товар_2"}'
	И я запоминаю строку "23.86" в переменную '{"VATAmount_Товар_2"}'
	И я запоминаю строку "10" в переменную '{"СтавкаНДС_Товар_2"}'
	И я запоминаю строку "23,86" в переменную '{"СуммаНДС_Товар_2"}'
