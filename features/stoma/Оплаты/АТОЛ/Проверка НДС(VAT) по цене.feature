...
Сценарий: 07. В чеке "VATRate=15"
	И Я открываю основную форму списка справочника "Организации"
	И в таблице 'Список' я выбираю текущую строку

	И из выпадающего списка с именем 'ПолеФормыСтавкаНДС_0' я выбираю точное значение "15%"
	И из выпадающего списка с именем 'ПолеФормыСтавкаНДС_1' я выбираю точное значение "15%"
	И из выпадающего списка с именем 'ПолеФормыСтавкаНДС_2' я выбираю точное значение "15%"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

* Ввод переменных для проверки xml
	И я запоминаю строку "15" в переменную 'VATRate'
	И я запоминаю строку "83.94" в переменную 'VATAmount'
	И я запоминаю строку "15" в переменную 'СтавкаНДС'
	И я запоминаю строку "83,94" в переменную 'СуммаНДС'
	И я запоминаю строку "321.77" в переменную 'ЦенаСоСкидкой'
	И я запоминаю строку "643.54" в переменную 'СуммаСоСкидкой'
	И я запоминаю строку "-83.94" в переменную 'СуммаСкидки'
...
Сценарий: 08. В чеке "VATRate=16"
	И Я открываю основную форму списка справочника "Организации"
	И в таблице 'Список' я выбираю текущую строку

	И из выпадающего списка с именем 'ПолеФормыСтавкаНДС_0' я выбираю точное значение "16%"
	И из выпадающего списка с именем 'ПолеФормыСтавкаНДС_1' я выбираю точное значение "16%"
	И из выпадающего списка с именем 'ПолеФормыСтавкаНДС_2' я выбираю точное значение "16%"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

* Ввод переменных для проверки xml
	И я запоминаю строку "16" в переменную 'VATRate'
	И я запоминаю строку "89.54" в переменную 'VATAmount'
	И я запоминаю строку "16" в переменную 'СтавкаНДС'
	И я запоминаю строку "89,54" в переменную 'СуммаНДС'
	И я запоминаю строку "324.57" в переменную 'ЦенаСоСкидкой'
	И я запоминаю строку "649.14" в переменную 'СуммаСоСкидкой'
	И я запоминаю строку "-89.54" в переменную 'СуммаСкидки'
...
* Ввод переменных для проверки xml
	И я запоминаю строку "22" в переменную 'VATRate'
	И я запоминаю строку "123.11" в переменную 'VATAmount'
	И я запоминаю строку "22" в переменную 'СтавкаНДС'
	И я запоминаю строку "123,11" в переменную 'СуммаНДС'
	И я запоминаю строку "341.36" в переменную 'ЦенаСоСкидкой'
	И я запоминаю строку "682.71" в переменную 'СуммаСоСкидкой'
	И я запоминаю строку "-123.11" в переменную 'СуммаСкидки'
...
Сценарий: 10. Возврат к исходному состоянию
	И Я открываю основную форму списка справочника "Организации"
	И в таблице 'Список' я выбираю текущую строку
