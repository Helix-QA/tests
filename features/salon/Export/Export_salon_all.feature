...
Сценарий: Я создаю набор услуг
	...
	И в поле с именем 'КоличествоСН_0' я ввожу текст "5"
	И я нажимаю на кнопку с именем 'ДобавитьСтрокуНабора'
	...
	И в поле с именем 'КоличествоСН_1' я ввожу текст "5"	
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
		
Сценарий: Я создаю набор запасов
	И Я создаю Товар
	И Я создаю Товар_2
	И Я запоминаю случайное число в переменную "НаборЗапасов"
	Дано я запоминаю значение выражения '"НаборЗапасов" + Формат($НаборЗапасов$, "ЧГ=0")' в переменную "$$НаборЗапасов$$"
	Дано Я открываю основную форму справочника "Номенклатура"
	...
	И в поле с именем 'НоменклатураСН_0' я ввожу текст "$$Товар$$"
	И из выпадающего списка с именем 'НоменклатураСН_0' я выбираю "$$Товар$$"
	И в поле с именем 'КоличествоСН_0' я ввожу текст "2"
	И я нажимаю на кнопку с именем 'ДобавитьСтрокуНабораЗапасов'	
	И в поле с именем 'НоменклатураСН_1' я ввожу текст "$$Товар_2$$"
	И из выпадающего списка с именем 'НоменклатураСН_1' я выбираю "$$Товар_2$$"
	И в поле с именем 'КоличествоСН_1' я ввожу текст "2"	
	И я нажимаю на кнопку с именем 'КнопкаДобавитьЦену'
	Тогда открылось окно "1С:Предприятие"
	И я нажимаю на кнопку с именем 'Button0'
	И я выбираю из списка 'Розничная цена '
	И в поле с именем '_Цена_0' я ввожу текст "1 500,00"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

Сценарий: Я создаю имущество
	И Я запоминаю случайное число в переменную "Имущество"
	Дано я запоминаю значение выражения '"Имущество" + Формат($Имущество$, "ЧГ=0")' в переменную "$$Имущество$$"
	Дано Я открываю основную форму справочника "Номенклатура"
	...
	И я нажимаю на кнопку с именем 'Button0'
	И я выбираю из списка 'Розничная цена '
	И в поле с именем '_Цена_0' я ввожу текст "650,00"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

Сценарий: Я создаю ресурсы
	И Я запоминаю случайное число в переменную "Ресурсы"
	Дано я запоминаю значение выражения '"Ресурсы" + Формат($Ресурсы$, "ЧГ=0")' в переменную "$$Ресурсы$$"
	Дано Я открываю основную форму справочника "Ресурсы"
	И в поле с именем 'Наименование' я ввожу текст '$$Ресурсы$$'
	И я нажимаю на кнопку с именем 'КнопкаДополнительно'
	И в поле с именем 'СтруктурнаяЕдиница' я ввожу текст "SPA-Салон"		
	И из выпадающего списка с именем 'СтруктурнаяЕдиница' я выбираю "SPA-Салон \"Меланж\" "
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

Сценарий: Я создаю ресурсы_2
	И Я запоминаю случайное число в переменную "ресурсы_2"
	Дано я запоминаю значение выражения '"ресурсы_2" + Формат($ресурсы_2$, "ЧГ=0")' в переменную "$$ресурсы_2$$"
	Дано Я открываю основную форму справочника "Ресурсы"
	И в поле с именем 'Наименование' я ввожу текст '$$ресурсы_2$$'
	И я нажимаю на кнопку с именем 'КнопкаДополнительно'
	И в поле с именем 'СтруктурнаяЕдиница' я ввожу текст "SPA-Салон"		
	И из выпадающего списка с именем 'СтруктурнаяЕдиница' я выбираю "SPA-Салон \"Меланж\" "
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

Сценарий: Я создаю ресурсы_3
	И Я запоминаю случайное число в переменную "ресурсы_3"
	Дано я запоминаю значение выражения '"ресурсы_3" + Формат($ресурсы_3$, "ЧГ=0")' в переменную "$$ресурсы_3$$"
	Дано Я открываю основную форму справочника "Ресурсы"
	И в поле с именем 'Наименование' я ввожу текст '$$ресурсы_3$$'
	И я нажимаю на кнопку с именем 'КнопкаДополнительно'
	И в поле с именем 'СтруктурнаяЕдиница' я ввожу текст "SPA-Салон"		
	И из выпадающего списка с именем 'СтруктурнаяЕдиница' я выбираю "SPA-Салон \"Меланж\" "
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
...
Сценарий: Я создаю подарочный электронный сертификат.
	...
	И из выпадающего списка с именем 'СертификатВидЛицевогоСчета' я выбираю "Основной"
...
Сценарий: Я Оплитил документ по возврату
...
Сценарий: Я создаю даты
	...
	И Я запоминаю значение выражения 'Формат(ДобавитьМесяц(ТекущаяДата(), 12), "ДЛФ=Д")' в переменную "$$СегодняПлюсГод$$"
...
Сценарий: Я создаю Мастера_3
	И Я запоминаю случайное число в переменную "Мастер"
	Дано я запоминаю значение выражения '"Мастер_3" + Формат($Мастер$, "ЧГ=0")' в переменную "$$Мастер_3$$"
	Дано Я открываю основную форму справочника "Сотрудники"
	И в поле с именем 'Фамилия' я ввожу текст '$$Мастер_3$$'
	И из выпадающего списка с именем "РольПользователяВОсновнойИнформацие" я выбираю точное значение 'Мастер салона красоты'
	И я нажимаю на кнопку с именем 'Записать'
	И я сохраняю навигационную ссылку текущего окна в переменную "$$СсылкаМастер_3$$"		
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

Сценарий: Я нажимаю на кнопку оплаты оплата 'ИмяКнопки'
//Определяет по указанной кнопке её существование на текущей форме оплаты, если она существует и 
//имеет видимость на форме, то на неё будет сделано нажатие
	И я выполняю код встроенного языка
	"""bsl
...
Сценарий: Я создаю начисленеи и удержание
		И в поле с именем 'ПериодС' я ввожу текст "01.01.2025"
		И в поле с именем 'ПериодПо' я ввожу текст "01.01.2050"
		И в поле с именем 'СтруктурнаяЕдиница' я ввожу текст "Spa-Салон"
		И из выпадающего списка с именем 'СтруктурнаяЕдиница' я выбираю "SPA-Салон \"Меланж\""
		И я нажимаю кнопку выбора у поля с именем 'ВидНачисленияИУдержания'
		И я нажимаю на кнопку с именем 'Создать'
		И Я запоминаю случайное число в переменную "Оклад"
		Дано я запоминаю значение выражения '"Оклад" + Формат($Оклад$, "ЧГ=0")' в переменную "$$Оклад$$"
