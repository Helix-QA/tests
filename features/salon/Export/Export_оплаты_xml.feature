...
*Проверка чека
	И элемент формы с именем 'XML' стал равен по шаблону
		...
		| '<CheckPackage>'                                                                                                                                                                                                                                       |
		| '	<Parameters CashierName=\"*\" OperationType=\"1\" TaxationSystem=\"$$СистемыНалогообложения$$\" SaleLocation="SPA-Салон &quot;Меланж&quot;  " CustomerEmail=\"\" CustomerPhone=\"\" GroupingPositionsWhenPrinting="false" OperationOnline="false">'                                                                                                              |
		| '		<AgentData/>'                                                                                                                                                                                                                                       |
		| '		<VendorData/>'                                                                                                                                                                                                                                      |
		| '		<CustomerDetail/>'                                                                                                                                                                                                                                  |
...
* Проверка чека
	И элемент формы с именем 'XML' стал равен по шаблону
		| '<?xml version=\"1.0\" encoding=\"UTF-8\"?>'                                                                                                                                                                                                           |
		| '<CheckPackage>'                                                                                                                                                                                                                                       |
		| '	<Parameters CashierName=\"*\" OperationType=\"2\" TaxationSystem=\"$$СистемыНалогообложения$$\" SaleLocation="SPA-Салон &quot;Меланж&quot;  " CustomerEmail=\"\" CustomerPhone=\"\" GroupingPositionsWhenPrinting="false" OperationOnline="false">'                                                                                                                                       |
		| '		<AgentData/>'                                                                                                                                                                                                                                       |
		| '		<VendorData/>'                                                                                                                                                                                                                                      |
		| '		<CustomerDetail/>'                                                                                                                                                                                                                                  |
		| '		<OperationalAttribute/>'                                                                                                                                                                                                                            |
