...
//		И из выпадающего списка с именем 'ИмяКонтрагента' я выбираю "$КлиентТриггер$"
	...
	*Создание претензии
		...
		И В командном интерфейсе я выбираю "Продажи" "Визиты"
		Когда открылось окно "Визиты (список)"
...
Сценарий: Проверка всех способов отправки по триггеру - Создание визита. //858203
	*Создание данных
		И я удаляю все переменные
		И Я создаю клиента для триггерных событий
		И Я создаю мастера салона красоты для триггерных событий
	...
	*Создание сценариев чат-бота.
		И я выполняю код встроенного языка на сервере
			"""bsl
				ОбновлениеИнформационнойБазыСалон.ИнициализироватьСистемуВзаимодействияЧатБота();
			"""
	
	*Настройка шаблона сообщений для триггера.
		Дано я открываю основную форму списка справочника "ШаблоныСообщений"
		Тогда открылось окно 'Шаблоны сообщений'		
		И я активизирую дополнение формы с именем 'СтрокаПоиска'
		И в дополнение формы с именем 'СтрокаПоиска' я ввожу текст "$Шаблон$"
		...
		*Заполнение письма.
			И я нажимаю на кнопку с именем 'ШаблонПисьмо'
			И в таблице 'ДеревоРеквизитов' я разворачиваю строку:
				| "Представление" |
				| "Текущая дата"  |
			И в таблице 'ДеревоРеквизитов' я перехожу к строке:
		...
		*Заполнение задачи.
			...
			И в таблице 'ДеревоРеквизитов' я перехожу к строке:
				...
				| "$ТекущаяДата$" |				
			И в таблице 'ДеревоРеквизитов' я выбираю текущую строку			
			И я нажимаю кнопку выбора у поля с именем 'ЗадачаВидВзаимодействия'
			Тогда открылось окно "Виды взаимодействий"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование" |
				| "Прочее"       |
			И я нажимаю на кнопку с именем 'КнопкаВыбрать'
			И в поле с именем 'ЗадачаПериодВыполнения' я ввожу текст "1"
			И в таблице 'ДеревоРеквизитов' я активизирую поле с именем 'ОбъектРеквизитовПредставление'
			И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

	*Создание сегмента сотрудников.
		Дано я открываю основную форму справочника "СегментыСотрудников"
		И Я запоминаю случайное число в переменную "СегментыСотрудников"
		Дано я запоминаю значение выражения '"СегментыСотрудников" + Формат($СегментыСотрудников$, "ЧГ=0")' в переменную "$$СегментыСотрудников$$"
		И в поле с именем "Наименование" я ввожу текст "$$СегментыСотрудников$$"
		*Добавление мастера 2.
			И я нажимаю на кнопку с именем 'ДобавитьВСегмент'
			Тогда открылось окно "1С:Предприятие"
			И я нажимаю на кнопку с именем 'Button0'
			И я активизирую дополнение формы с именем 'СтрокаПоиска'
			И в дополнение формы с именем 'СтрокаПоиска' я ввожу текст "$$Мастер_2$$"
			И я жду, что в таблице "Список" количество строк будет "больше" 0 в течении 20 секунд
			И в таблице 'Список' я перехожу к строке по шаблону
				| 'Сотрудник'      |
				| '*$$Мастер_2$$*' |
			И в таблице "Список" я выбираю текущую строку
		*Добавление мастера 3.
			И я нажимаю на кнопку с именем 'ДобавитьВСегмент'
			И я активизирую дополнение формы с именем 'СтрокаПоиска'
			И в дополнение формы с именем 'СтрокаПоиска' я ввожу текст "$$Мастер_3$$"
			И я жду, что в таблице "Список" количество строк будет "больше" 0 в течении 20 секунд
			И в таблице 'Список' я перехожу к строке по шаблону
				| 'Сотрудник'      |
				| '*$$Мастер_3$$*' |
	...
	*Включение настройки "Использовать Чат-бота" в разделе "Общие настройки"
		И В командном интерфейсе я выбираю "Настройки" "Общие настройки"
		Тогда открылось окно "Общие настройки"
		И я устанавливаю флаг с именем 'ИспользоватьЧатБот'
		И Я закрываю окно "Общие настройки"
	
	*Настройка сценария чат-бота "Подтверждение записи".
		Дано я открываю основную форму списка справочника "СценарииЧатБотов"
		И в таблице 'Список' я перехожу к строке:
			| 'Наименование'                  |
			| 'Подтверждение записи'          |
		И в таблице 'Список' я выбираю текущую строку
		И я нажимаю на кнопку с именем 'РедактироватьТриггерныеСобытия'
		Тогда открылось окно 'Доступные триггерные события'							
		И в таблице 'ДеревоТриггерныхСобытий' я перехожу к строке:
			| 'Представление триггерного события' |
			| 'Создание визита'                   |
		И в таблице 'ДеревоТриггерныхСобытий' я устанавливаю флаг с именем 'ДеревоТриггерныхСобытийИспользуется'
		И в таблице 'ДеревоТриггерныхСобытий' я завершаю редактирование строки
		И я нажимаю на кнопку с именем 'КнопкаСохранить'
		И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
					
	*Включение триггеров через общую форму.	
		Дано Я открываю общую форму "ИспользоватьТриггерныеСобытия"
		Когда открылось окно "Использовать триггерные события"
		И я меняю значение переключателя с именем 'ИспользоватьТриггерныеСобытия' на "Использовать триггерные события"
	...
	*Очистка списка триггерных событий и создание триггера по текущему событию.
		...
		И в поле с именем "Наименование" я ввожу значение выражения "Создание визита $$СлучайноеЧисло$$"
		И я запоминаю значение поля с именем 'Наименование' как "Наименование"
		*Вид действия - "Отправить сообщение", получатель - "Клиент события".
			И из выпадающего списка с именем 'ВидДействия_Индекс_0' я выбираю точное значение "Отправить сообщение"
			И я перехожу к закладке с именем 'ВсплывающаяГруппаПараметровДействия_Индекс_0'
			И из выпадающего списка с именем 'ВидПолучателя_Индекс_0' я выбираю точное значение "Клиент события"
			И я устанавливаю флаг с именем 'ОтправкаSMS_Индекс_0'
			И из выпадающего списка с именем 'АккаунтСообщений_Индекс_0' я выбираю "Helix SMS, логин - test "			
			И из выпадающего списка с именем 'ШаблонСообщения_Индекс_0' я выбираю по строке "$Шаблон$"
			И я нажимаю на кнопку с именем 'ПрименитьПараметрыДействия_Индекс_0'
		*Вид действия - "Отправить сообщение", получатель - "Указанный сотрудник".
			И из выпадающего списка с именем 'ВидДействия_Индекс_1' я выбираю точное значение "Отправить сообщение"
			И я перехожу к закладке с именем 'ВсплывающаяГруппаПараметровДействия_Индекс_1'
			И из выпадающего списка с именем 'ВидПолучателя_Индекс_1' я выбираю точное значение "Указанный сотрудник"
			И в поле с именем 'Получатель_Индекс_1' я ввожу текст "$$Мастер$$"
			И из выпадающего списка с именем 'Получатель_Индекс_1' я выбираю "$$Мастер$$"
			И я устанавливаю флаг с именем 'ОтправкаSMS_Индекс_1'
			И из выпадающего списка с именем 'АккаунтСообщений_Индекс_1' я выбираю "Helix SMS, логин - test "
			И из выпадающего списка с именем 'ШаблонСообщения_Индекс_1' я выбираю "$Шаблон$"
			И я нажимаю на кнопку с именем 'ПрименитьПараметрыДействия_Индекс_1'						
		*Вид действия - "Отправить письмо", получатель - "Клиент события".
			И из выпадающего списка с именем 'ВидДействия_Индекс_2' я выбираю точное значение "Отправить письмо"
			И я перехожу к закладке с именем 'ВсплывающаяГруппаПараметровДействия_Индекс_2'
			И из выпадающего списка с именем 'ВидПолучателя_Индекс_2' я выбираю точное значение "Клиент события"
			И в поле с именем 'АккаунтEmail_Индекс_2' я ввожу текст "Системная учетная запись"
			И из выпадающего списка с именем 'АккаунтEmail_Индекс_2' я выбираю "Системная учетная запись"
			И из выпадающего списка с именем 'ШаблонСообщения_Индекс_2' я выбираю по строке "$Шаблон$"
			И я нажимаю на кнопку с именем 'ПрименитьПараметрыДействия_Индекс_2'
		*Вид действия - "Отправить письмо", получатель - "Указанный сотрудник".
			И из выпадающего списка с именем 'ВидДействия_Индекс_3' я выбираю точное значение "Отправить письмо"
			И я перехожу к закладке с именем 'ВсплывающаяГруппаПараметровДействия_Индекс_3'
			И из выпадающего списка с именем 'ВидПолучателя_Индекс_3' я выбираю точное значение "Указанный сотрудник"
			И в поле с именем 'Получатель_Индекс_3' я ввожу текст "$$Мастер$$"
			И из выпадающего списка с именем 'Получатель_Индекс_3' я выбираю "$$Мастер$$"
			И в поле с именем 'АккаунтEmail_Индекс_3' я ввожу текст "Системная учетная запись"
			И из выпадающего списка с именем 'АккаунтEmail_Индекс_3' я выбираю "Системная учетная запись"
			И из выпадающего списка с именем 'ШаблонСообщения_Индекс_3' я выбираю по строке "$Шаблон$"
			И я нажимаю на кнопку с именем 'ПрименитьПараметрыДействия_Индекс_3'
		*Вид действия - "Поставить задачу", исполнитель - "Указанный сотрудник".
			И из выпадающего списка с именем 'ВидДействия_Индекс_4' я выбираю точное значение "Поставить задачу"
			И я перехожу к закладке с именем 'ВсплывающаяГруппаПараметровДействия_Индекс_4'
			И из выпадающего списка с именем 'ВидИсполнителя_Индекс_4' я выбираю "Указанный сотрудник"
			И в поле с именем 'Исполнитель_Индекс_4' я ввожу текст "$$Мастер$$"
			И из выпадающего списка с именем 'Исполнитель_Индекс_4' я выбираю "$$Мастер$$"
			И из выпадающего списка с именем 'ШаблонСообщения_Индекс_4' я выбираю по строке "$Шаблон$"
			И я нажимаю на кнопку с именем 'ПрименитьПараметрыДействия_Индекс_4'
		*Вид действия - "Поставить задачу", исполнитель - "Сегмент сотрудников".
			И из выпадающего списка с именем 'ВидДействия_Индекс_5' я выбираю точное значение "Поставить задачу"
			И я перехожу к закладке с именем 'ВсплывающаяГруппаПараметровДействия_Индекс_5'
			И из выпадающего списка с именем 'ВидИсполнителя_Индекс_5' я выбираю "Сегмент сотрудников"
			И в поле с именем 'Исполнитель_Индекс_5' я ввожу текст "$$СегментыСотрудников$$"
			И из выпадающего списка с именем 'Исполнитель_Индекс_5' я выбираю "$$СегментыСотрудников$$"
			И из выпадающего списка с именем 'ШаблонСообщения_Индекс_5' я выбираю по строке "$Шаблон$"			
			И я нажимаю на кнопку с именем 'ПрименитьПараметрыДействия_Индекс_5'
		*Вид действия - "Активировать чат-бота".
			И из выпадающего списка с именем 'ВидДействия_Индекс_6' я выбираю точное значение "Активировать чат-бота"
			И я перехожу к закладке с именем 'ВсплывающаяГруппаПараметровДействия_Индекс_6'
			И я нажимаю кнопку выбора у поля с именем 'СценарийЧатБота_Индекс_6'
			Тогда открылось окно 'Сценарии чат-бота'			
			И в таблице 'Список' я перехожу к строке:
				| 'Наименование'         |
				| 'Подтверждение записи' |
			И в таблице 'Список' я выбираю текущую строку
			И я нажимаю на кнопку с именем 'ПрименитьПараметрыДействия_Индекс_6'
		*Вид действия - "Повысить этап сделки".
			И из выпадающего списка с именем 'ВидДействия_Индекс_7' я выбираю точное значение "Повысить этап сделки"
			И в поле с именем 'ВидСделки_Индекс_7' я ввожу текст "Постоянный клиент"
			И из выпадающего списка с именем 'ВидСделки_Индекс_7' я выбираю "Постоянный клиент"
			И из выпадающего списка с именем 'ЭтапСделки_Индекс_7' я выбираю "3. Запись на повторный визит"
			И я устанавливаю флаг с именем 'СоздаватьСделку_Индекс_7'
			И в поле с именем 'КоличествоГенерацийСделок_Индекс_7' я ввожу текст "1"
			И я нажимаю на кнопку с именем 'ПрименитьПараметрыДействия_Индекс_7'
			Когда открылось окно "Триггерное событие (создание) *"
		И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'
	...
	*Проверка журнала регистрации триггерного события
		...
		*Проверка табличной части
			И таблица 'Список' содержит строки по шаблону:
				| 'Триггерное событие' | 'Действие (описание)'                                  | 'Статус события'   | 'Период'                | 'Клиент'          | 'Взаимодействие (задача)'      | 'Источник события' | 'Объект события'        | 'Салон'               | 'Сведения об ошибке или причине отклонения действия'                                                                                                                                   |
				| '$Наименование$'     | 'Отправить сотруднику сообщение'                       | 'Зарегистрировано' | '$ТекущаяДата$ в *:*:*' | '$КлиентТриггер$' | 'SMS сообщение в *:*, * * *. ' | ''                 | 'Запись в *:*, * * *. ' | 'SPA-Салон "Меланж" ' | ''                                                                                                                                                                                     |
				| '$Наименование$'     | 'Отправить клиенту сообщение'                          | 'Зарегистрировано' | '$ТекущаяДата$ в *:*:*' | '$КлиентТриггер$' | 'SMS сообщение в *:*, * * *. ' | ''                 | 'Запись в *:*, * * *. ' | 'SPA-Салон "Меланж" ' | ''                                                                                                                                                                                     |
				| '$Наименование$'     | 'Повысить этап сделки до: "Запись на повторный визит"' | 'Зарегистрировано' | '$ТекущаяДата$ в *:*:*' | '$КлиентТриггер$' | 'Постоянный клиент № *'        | ''                 | 'Запись в *:*, * * *. ' | 'SPA-Салон "Меланж" ' | ''                                                                                                                                                                                     |
				| '$Наименование$'     | 'Поставить задачу сотруднику'                          | 'Зарегистрировано' | '$ТекущаяДата$ в *:*:*' | '$КлиентТриггер$' | '$Шаблон$ (не выполнена)'      | ''                 | 'Запись в *:*, * * *. ' | 'SPA-Салон "Меланж" ' | ''                                                                                                                                                                                     |
				| '$Наименование$'     | 'Отправить сотруднику электронное письмо'              | 'Отклонено'        | '$ТекущаяДата$ в *:*:*' | '$КлиентТриггер$' | ''                             | ''                 | 'Запись в *:*, * * *. ' | 'SPA-Салон "Меланж" ' | 'Выбранная учетная запись электронной почты не активна'                                                                                                                                |
				| '$Наименование$'     | 'Поставить задачу сегменту сотрудников'                | 'Зарегистрировано' | '$ТекущаяДата$ в *:*:*' | '$КлиентТриггер$' | '$Шаблон$ (не выполнена)'      | ''                 | 'Запись в *:*, * * *. ' | 'SPA-Салон "Меланж" ' | ''                                                                                                                                                                                     |
				| '$Наименование$'     | 'Отправить клиенту электронное письмо'                 | 'Отклонено'        | '$ТекущаяДата$ в *:*:*' | '$КлиентТриггер$' | ''                             | ''                 | 'Запись в *:*, * * *. ' | 'SPA-Салон "Меланж" ' | 'Выбранная учетная запись электронной почты не активна'                                                                                                                                |
				| '$Наименование$'     | 'Запустить сценарий: "Подтверждение записи"'           | 'Отклонено'        | '$ТекущаяДата$ в *:*:*' | '$КлиентТриггер$' | ''                             | ''                 | 'Запись в *:*, * * *. ' | 'SPA-Салон "Меланж" ' | 'Не обнаружены соответствующие контактные данные получателя для рассылки сообщений, либо не корректно указан аккаунт уведомлений для структурной единицы регистрации данного события.' |