...
Сценарий: Новый журнал записи
	...
	*Проверка кнопки созданного визита в журнале записи
		И правый клик по координатам "800" "500"
	...
	*Проверка кнопки "Визит окончен"
		И клик по координатам "800" "470"		
		Если открылось окно "Визит в 17:00, *" тогда
			И Я закрываю окно "Визит в 17:00, *"
		И пауза 5
		И правый клик по координатам "650" "500"		
