...
| '22/122' | 'расчетная ставка 22/122' |
...
* Настройка НДС
	И я открываю текущую ставку НДС
	И в поле с именем 'Ставка' я ввожу текст "22"
	И я нажимаю на кнопку с именем 'ФормаКнопкаСохранитьИЗакрыть'

* Ввод переменных для проверки xml
	И я запоминаю строку "22" в переменную 'VATRate'
	И я запоминаю строку "90.16" в переменную 'VATAmount'
	И я запоминаю строку "22" в переменную 'СтавкаНДС'
	И я запоминаю строку "90,16" в переменную 'СуммаНДС'
	И я запоминаю строку "0" в переменную "TaxationSystem"
	...
	// --- Добавлено: для проверки с учетом цены включающей НДС
	И я запоминаю строку "305" в переменную 'ЦенаСоСкидкой'
	И я запоминаю строку "610" в переменную 'СуммаСоСкидкой'
	И я запоминаю строку "-110" в переменную 'СуммаСкидки'
	И я запоминаю строку "22" в переменную 'VATRate'
	И я запоминаю строку "110" в переменную 'VATAmount'
	И я запоминаю строку "22" в переменную 'СтавкаНДС'
	И я запоминаю строку "110,00" в переменную 'СуммаНДС'
...
* Ввод переменных для проверки xml
	И я запоминаю строку "22/122" в переменную 'VATRate'
	И я запоминаю строку "90.16" в переменную 'VATAmount'
	И я запоминаю строку "122" в переменную 'СтавкаНДС'
	И я запоминаю строку "90,16" в переменную 'СуммаНДС'
	И я запоминаю строку "0" в переменную "TaxationSystem"
...
Сценарий: 11. Проверка СНО Упрощенная
	* Ставка 5%
		И я закрываю все окна клиентского приложения
		* Настройка НДС
			И я открываю текущую ставку НДС
...
Сценарий: 12. Проверка СНО Упрощенная доход минус расход
	* Ставка 5%
		И я закрываю все окна клиентского приложения
		* Настройка НДС
			И я открываю текущую ставку НДС
...
Сценарий: 13. Возврат в исходное состояние
* Настройка организации
	И Я открываю основную форму списка справочника "Организации"
	И в таблице 'Список' я выбираю текущую строку
	И я снимаю флаг с именем 'АвансоваяСхемаПробитияУслуг'
