...
//Проверка снятия плашки.
	...
	И элемент формы с именем 'ПолеВидыОплатВводСуммыСтрока_2x0' стал равен "0"
	И элемент формы с именем 'ПолеВидыОплатВводСуммыСтрока_3x0' стал равен "500,00"
	И Я нажимаю на кнопку оплаты 'КнопкаВидыОплатПрименитьеСуммуСтрока_3x0'
	И я нажимаю на кнопку с именем 'Оплатить'
