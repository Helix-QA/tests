...
//		И в таблице '_ПодборНоменклатур' я выбираю текущую строку
		...
		И я нажимаю на кнопку с именем 'КнопкаВидыОплатаНаименованиеСтрока_2x0'
		И Я нажимаю на кнопку оплаты 'КнопкаВидыОплатПрименитьеСуммуСтрока_2x0'
		И элемент формы с именем 'Внесено' стал равен "5 435,00"
		И элемент формы с именем 'ПолеВидыОплатВводСуммыСтрока_2x0' стал равен "5 435"
...
*Проверка XML после оплаты сертификатом
	...
	И в поле с именем 'ПолеВводаСерииСертификата_3x0' я ввожу значение переменной "$СерияСертификата$"
