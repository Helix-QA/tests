...
Сценарий: Проверяю статус звонка от клиента
	...
	*Проверка открытие клиента после создания
		...
		И элемент формы с именем 'Статус_0' стал равен "Завершен"
...
Сценарий: Проверяю пропущенного звонка и кнопку внести в чёрный список
	...
	*Проверка звонка в заявках 
		И я нажимаю на кнопку с именем 'Кнопка_ОткрытьЗаявку_0'								
		И элемент формы с именем 'ИсторияВзаимодействия' стал равен по шаблону
			|'           		<div class=\"text-message\" style=\"color: #000\">...</div>'|
