...
Сценарий: Чек коррекции "Неприменение ККТ"
	*загрузка данных
	...
	*Создание продажи
		...
		Дано Я запоминаю значение выражения 'Формат(ТекущаяДата(), "ДФ=чч:мм")' в переменную "$$ТекЧасМин3$$"
	...
	*Проверк "Чек коррекции"
		...
		И элемент формы с именем 'ДокументРасчетов' стал равен ""
		И элемент формы с именем 'ДокументРасчетовНедоступен' стал равен ""
		...
		И элемент формы с именем 'ПокупательИНН' стал равен ""
		И элемент формы с именем 'ПокупательИНННеприменениеККТ' стал равен ""
...
Сценарий: Чек коррекции "Пробит чек"
	*загрузка данных
		И я удаляю все переменные
		И я создаю клиента
		И Я создаю Услуга_Групповая
	...
	*Проверка "Создание чеков коррекции"
		...
		И таблица 'ПозицииЧека' стала равной по шаблону:
			...
			| '1' | '1 250,00'          | '$$УслугаГрупповая$$'           | '5,000'      | ''             | '250,00'           | '1'            | 'Работа'                   | 'Без НДС'    | ''          | ''         | 'Аванс'                   | ''                                   | ''             | ''    | ''        |
		И элемент формы с именем 'РасчетВИнтернете' стал равен "Нет"
		И элемент формы с именем 'СистемаНалогообложения' стал равен "Общая"
		И элемент формы с именем 'СтруктурнаяЕдиница' стал равен "Фитнес плюс"
		И элемент формы с именем 'СуммаДокумента' стал равен "1 250,00"
		И у элемента формы с именем 'СуммаДокумента' текст редактирования стал равен "1 250,00"
		И элемент формы с именем 'СуммаНДС' стал равен "0,00"
		И у элемента формы с именем 'СуммаНДС' текст редактирования стал равен "0,00"
		И элемент формы с именем 'СуммаОплаты' стал равен "1 250,00"
		И у элемента формы с именем 'СуммаОплаты' текст редактирования стал равен "1 250,00"
		...
		И у элемента формы с именем 'ТипКоррекции' текст редактирования стал равен "Самостоятельно"
		И элемент формы с именем 'ТипРасчета' стал равен "Приход денежных средств"
		И элемент формы с именем 'ЧекСкорректированный' стал равен по шаблону "Чек коррекции * от $$ЦифроваяДата$$ $$ТекЧасМин$$ "
		И элемент формы с именем 'ЧекСкорректированныйСтатус' стал равен "1"
		И у элемента формы с именем 'ЧекСкорректированныйСтатус' текст редактирования стал равен "1"
		И элемент формы с именем 'ЧекСторно' стал равен по шаблону "Чек коррекции * от $$ЦифроваяДата$$ $$ТекЧасМин$$ (сторно)"
		И элемент формы с именем 'ЧекСторноСтатус' стал равен "1"
...
Сценарий: Проверка на работаспособность документов, открытие всех чек коррекций, сообщений
	*загрузка данных
		И я удаляю все переменные
		И я создаю клиента
		И Я создаю Услуга_Групповая
