...
Сценарий: Чек коррекции "Неприменение ККТ" №2
	*Проверка открытие через справочник №1
		...
		И в таблице 'Список' я перехожу к строке по шаблону:
			...
			| "$$ЦифроваяДата$$ *" | "Да"               | "$$НомерДокумента$$" | "Основная ораганизация" | "Нет"        | "Нет"    | "Приход денежных средств" |
		И в таблице 'Список' я выбираю текущую строку
...
Сценарий: Чек коррекции "Неприменение ККТ" №3
	*Проверка открытие через справочник №2
		...
		И в таблице 'Список' я перехожу к строке:
			| "Дата"               | "Касса"                  | "Номер"              | "Организация"           | "Сумма" | "Тип документа"          | "Тип расчета"             |
			| "$$ЦифроваяДата$$ *" | "Основная касса (касса)" | "$$НомерДокумента$$" | "Основная ораганизация" | "250"   | "Кассовый чек коррекции" | "Приход денежных средств" |
		И в таблице 'Список' я выбираю текущую строку
		И я нажимаю на кнопку с именем 'КнопкаЗаписать'
...
Сценарий: Чек коррекции "Неприменение ККТ" №4
	*Проверк "Чек коррекции"
		И я перехожу по навигационной ссылке "e1cib/list/ЖурналДокументов.ЖурналЧековКоррекции"
		И в таблице 'Список' я перехожу к строке:
			| "Автор" | "Дата"               | "Номер"              | "Касса"                  | "Организация"           | "Сумма" | "Тип документа"          | "Тип расчета"             |
			| "Админ" | "$$ЦифроваяДата$$ *" | "$$НомерДокумента$$" | "Основная касса (касса)" | "Основная ораганизация" | "250"   | "Кассовый чек коррекции" | "Приход денежных средств" |
		И в таблице 'Список' я выбираю текущую строку
		...
		И элемент формы с именем 'ДокументОснование' стал равен по шаблону "Продажа * от $$ЦифроваяДата$$ * "
		...
		И Я закрываю окно "Чек коррекции * от *"
...
Сценарий: Чек коррекции "Неприменение ККТ" №5				
	*Проверка открытие через справочник №1
		...
		И в таблице 'Список' я перехожу к строке:
			| "Дата"               | "Неприменение ККТ" | "Номер"              | "Организация"           | "Пробит чек" | "Сторно" | "Тип расчета"             |
			| "$$ЦифроваяДата$$ *" | "Да"               | "$$НомерДокумента$$" | "Основная ораганизация" | "Да"         | "Нет"    | "Приход денежных средств" |
		И в таблице 'Список' я выбираю текущую строку
		И я закрываю все окна клиентского приложения
...
Сценарий: Чек коррекции "Неприменение ККТ" №6	
	*Проверка открытие через справочник №2
		...
		И в таблице 'Список' я перехожу к строке:
			...
			| "Админ" | "$$ЦифроваяДата$$ *" | "Основная касса (касса)" | "$$НомерДокумента$$" | "Основная ораганизация" | "250"   | "Кассовый чек коррекции" | "Приход денежных средств" |
		И в таблице 'Список' я выбираю текущую строку
...
Сценарий: Чек коррекции "Пробит чек" №3	
	*Проверка "Создание чеков коррекции"
		...
		И в таблице 'Список' я перехожу к строке по шаблону:
			...
			| "$$ЦифроваяДата$$ *" | "$$МойДопРеквизит$$"      | "Нет"              | "Основная ораганизация" | "Да"         | "Да"     | "Возврат денежных средств" |
		И в таблице 'Список' я выбираю текущую строку
		И элемент формы с именем 'АвторДокумента' стал равен "Админ"
...
Сценарий: Чек коррекции "Пробит чек" №5
	*Проверка открытие через справочник №2
		...
		И в таблице 'Список' я перехожу к строке:
			...
			| "Админ" | "$$ЦифроваяДата$$ *" | "Основная касса (касса)" | "Основная ораганизация" | "1 250" | "Чек коррекции" | "Приход денежных средств" |
		И в таблице 'Список' я выбираю текущую строку
		И я закрываю текущее окно
		И в таблице 'Список' я перехожу к строке:
			| "Автор" | "Дата"               | "Касса"                  | "Организация"           | "Сумма" | "Тип документа" | "Тип расчета"              |
			| "Админ" | "$$ЦифроваяДата$$ *" | "Основная касса (касса)" | "Основная ораганизация" | "250"   | "Чек коррекции" | "Возврат денежных средств" |
		И в таблице 'Список' я выбираю текущую строку
		И я закрываю все окна клиентского приложения
...
Сценарий: Чек коррекции оплата "Лицевым счётом" №1
	...
	*Создание продажи
		...
		И Я нажимаю на кнопку оплаты 'КнопкаВидыОплатПрименитьеСуммуСтрока_2x0'
		И я нажимаю на кнопку с именем 'Оплатить'
