...
Сценарий: Чек коррекции "Неприменение ККТ" №3
	*Проверка открытие через справочник №2
		...
		И в таблице 'Список' я перехожу к строке:
			...
			| "Админ" | "$$ЦифроваяДата$$ $$ТекЧасМин2$$:*" | "Основная касса (касса)" | "Основная ораганизация" | "250"   | "Кассовый чек коррекции" | "Приход денежных средств" |
		И в таблице 'Список' я выбираю текущую строку
...
Сценарий: Чек коррекции "Неприменение ККТ" №4
	*Проверк "Чек коррекции"
		...
		И элемент формы с именем 'Дата' стал равен по шаблону "$$ЦифроваяДата$$ $$ТекЧасМин$$:*"
		...
		И элемент формы с именем 'ДокументОснование' стал равен по шаблону "Продажа * от $$ЦифроваяДата$$ $$ТекЧасМин4$$ "
...
Сценарий: Чек коррекции "Неприменение ККТ" №5				
	*Проверка открытие через справочник №1
		...
		И в таблице 'Список' я перехожу к строке:
			...
			| "$$ЦифроваяДата$$ $$ТекЧасМин$$:*" | "Да"               | "$$НомерДокумента$$" | "Основная ораганизация" | "Да"         | "Нет"    | "Приход денежных средств" |
		И в таблице 'Список' я выбираю текущую строку
		И я закрываю все окна клиентского приложения
...
Сценарий: Чек коррекции "Неприменение ККТ" №6	
	*Проверка открытие через справочник №2
		...
		И в таблице 'Список' я перехожу к строке:
			...
			| "Админ" | "$$ЦифроваяДата$$ $$ТекЧасМин$$:*" | "Основная касса (касса)" | "$$НомерДокумента$$" | "Основная ораганизация" | "250"   | "Кассовый чек коррекции" | "Приход денежных средств" |
		И в таблице 'Список' я выбираю текущую строку
