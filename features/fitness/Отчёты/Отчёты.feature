...
//Проверка на заполнение отчёта активные пакеты услуг
	...
	И в поле с именем 'InputFld' я ввожу текст "26.09.2025"
...
//	И из выпадающего списка с именем 'ЭквайрингТерминал' я выбираю точное значение "02.Юкасса, Основная ораганизация (эквайринг)"
...
//	И из выпадающего списка с именем 'ВидОперации' я выбираю точное значение "Прочее поступление"
