...
Сценарий: Проверка всех ролей у пользователя "ПроверкаРолей"
...
Сценарий: Создание пользователей.
	*Создание Администратора рецепции.
		И Я запоминаю случайное число в переменную "АдминРецепции"
		Дано я запоминаю значение выражения '"АдминРецепции" + Формат($АдминРецепции$, "ЧГ=0")' в переменную "$$АдминРецепции$$"
		Дано я открываю основную форму справочника "Сотрудники"
		И в поле с именем "Фамилия" я ввожу текст "$$АдминРецепции$$"
		И из выпадающего списка с именем 'РольПользователяВОсновнойИнформацие' я выбираю "Администратор рецепции"
		...
		И я нажимаю на кнопку с именем 'СписокДоступныеКассыКнопкаДобавить'
		И в меню формы я выбираю 'Проверка отчётов (касса)'
		И я устанавливаю флаг с именем 'ДоступКИнформационнойБазеРазрешен'	
		И я нажимаю на кнопку с именем '_СвойстваПользователяИБ'
		И в поле с именем 'ПользовательИБИмя2' я ввожу текст "$$АдминРецепции$$"
	...
	*Создание Тренера.
		...
		И из выпадающего списка с именем 'РольПользователяВОсновнойИнформацие' я выбираю "Тренер"
		И я нажимаю на кнопку с именем 'СписокДоступныеКассыКнопкаДобавить'
		И в меню формы я выбираю 'Основная касса (касса)'
		И я нажимаю на кнопку с именем 'СписокДоступныеКассыКнопкаДобавить'
		И в меню формы я выбираю 'ОнлайнКасса (касса)'
	...
	*Создание Менеджера отдела продаж.
		И Я запоминаю случайное число в переменную "МенеджерОП"
		Дано я запоминаю значение выражения '"МенеджерОП" + Формат($МенеджерОП$, "ЧГ=0")' в переменную "$$МенеджерОП$$"
		Дано я открываю основную форму справочника "Сотрудники"
		И в поле с именем "Фамилия" я ввожу текст "$$МенеджерОП$$"
		И из выпадающего списка с именем 'РольПользователяВОсновнойИнформацие' я выбираю "Менеджер отдела продаж"
		И я нажимаю на кнопку с именем 'СписокДоступныеКассыКнопкаДобавить'
		И в меню формы я выбираю 'Основная касса (касса)'
		И я нажимаю на кнопку с именем 'СписокДоступныеКассыКнопкаДобавить'
		И в меню формы я выбираю 'ОнлайнКасса (касса)'
		...
		И я устанавливаю флаг с именем 'ДоступКИнформационнойБазеРазрешен'	
		И я нажимаю на кнопку с именем '_СвойстваПользователяИБ'
		И в поле с именем 'ПользовательИБИмя2' я ввожу текст "$$МенеджерОП$$"
		И я перехожу к закладке с именем 'ИмяСОтметкойНезаполненного'
	...
	*Создание Кладовщика.
		...
		И из выпадающего списка с именем 'РольПользователяВОсновнойИнформацие' я выбираю "Кладовщик"
		И я нажимаю на кнопку с именем 'СписокДоступныеКассыКнопкаДобавить'
		И в меню формы я выбираю 'Основная касса (касса)'
		И я нажимаю на кнопку с именем 'СписокДоступныеКассыКнопкаДобавить'
		И в меню формы я выбираю 'ОнлайнКасса (касса)'
	...
	*Создание Бухгалтера.
		И Я запоминаю случайное число в переменную "Бухгалтер"
		Дано я запоминаю значение выражения '"Бухгалтер" + Формат($Бухгалтер$, "ЧГ=0")' в переменную "$$Бухгалтер$$"
		Дано я открываю основную форму справочника "Сотрудники"
		И в поле с именем "Фамилия" я ввожу текст "$$Бухгалтер$$"
		И из выпадающего списка с именем 'РольПользователяВОсновнойИнформацие' я выбираю "Бухгалтер"
		И я нажимаю на кнопку с именем 'СписокДоступныеКассыКнопкаДобавить'
		И в меню формы я выбираю 'Основная касса (касса)'
		И я нажимаю на кнопку с именем 'СписокДоступныеКассыКнопкаДобавить'
		И в меню формы я выбираю 'ОнлайнКасса (касса)'
	...
	*Создание Директора.
		И Я запоминаю случайное число в переменную "Директор"
		Дано я запоминаю значение выражения '"Директор" + Формат($Директор$, "ЧГ=0")' в переменную "$$Директор$$"
		Дано я открываю основную форму справочника "Сотрудники"
		И в поле с именем "Фамилия" я ввожу текст "$$Директор$$"
		И из выпадающего списка с именем 'РольПользователяВОсновнойИнформацие' я выбираю "Директор"
		И я нажимаю на кнопку с именем 'СписокДоступныеКассыКнопкаДобавить'
		И в меню формы я выбираю 'Основная касса (касса)'
		И я нажимаю на кнопку с именем 'СписокДоступныеКассыКнопкаДобавить'
		И в меню формы я выбираю 'ОнлайнКасса (касса)'
