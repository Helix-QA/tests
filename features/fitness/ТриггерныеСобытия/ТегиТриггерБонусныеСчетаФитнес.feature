...
Сценарий: Проверка триггерного события - Начисление на бонусный счет
	...
	*Активация - Начисление на бонусный счет
		...
		И я активизирую окно 'Виды бонусных счетов'		
		И я нажимаю на кнопку с именем 'Создать'
		И я активизирую окно 'Вид бонусного счета (создание)'		
		...
		И в поле с именем 'Владелец' я ввожу значение выражения'$$Клиент$$'
