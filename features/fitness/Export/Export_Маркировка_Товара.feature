...
//	И Я запоминаю значение выражения 'AttributeValue=\"UUID=test-cd41xs5a1w15d1&amp;' в переменную "AttributeValue"
	И Я запоминаю значение выражения 'AttributeValue="UUID=test-638f669e-7e8e-85a9-3453-2c429d001150&amp;Time=1731658318006&amp;Inst=4c182ce0-a325-42a9-ab9e-b5e562cc8721&amp;Ver=52cadcfe-a28f-4877-8b2f-da0481ddf1fa"' в переменную "AttributeValue"
Если переменная "Маркировка" имеет значение "0104640033503572221Y!OkcBHelix93iTAJ" Тогда
	И Я запоминаю значение выражения 'MarkingCode=\"MDEwNDY0MDAzMzUwMzU3MjIyMVkhT2tjQh05M2lUQUo=\"' в переменную "MarkingCode"
	И Я запоминаю значение выражения '0104640033503572221Y!OkcB93iTAJ' в переменную "Штрихкод"
	И Я запоминаю значение выражения 'AttributeValue=\"UUID=test-638f669e-7e8e-85a9-3453-2c429d001150&amp;Time=1731658318006&amp;Inst=4c182ce0-a325-42a9-ab9e-b5e562cc8721&amp;Ver=52cadcfe-a28f-4877-8b2f-da0481ddf1fa\"' в переменную "AttributeValue"
Если переменная "Маркировка" имеет значение "0104640033503572222Y!OkcBHelix93iTAJ" Тогда
	И Я запоминаю значение выражения 'MarkingCode=\"MDEwNDY0MDAzMzUwMzU3MjIyMlkhT2tjQh05M2lUQUo=\"' в переменную "MarkingCode"
	И Я запоминаю значение выражения '0104640033503572222Y!OkcB93iTAJ' в переменную "Штрихкод"
	И Я запоминаю значение выражения 'AttributeValue=\"UUID=test-638f669e-7e8e-85a9-3453-2c429d001150&amp;Time=1731658318006&amp;Inst=4c182ce0-a325-42a9-ab9e-b5e562cc8721&amp;Ver=52cadcfe-a28f-4877-8b2f-da0481ddf1fa\"' в переменную "AttributeValue"
