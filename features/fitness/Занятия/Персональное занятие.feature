...
//Создание занятия+смена данных после его проведения.	
	...
	И таблица 'Список' содержит строки по шаблону:
		| 'Сотрудник'   | 'Регистратор'                                                  | 'Занятие'                                                                                                | 'Услуга, сегмент'                                                    |
		| '$$Тренер2$$' | 'Запись на занятие * от $$Сегодня$$ *:*' | 'Персональное: $$Сегодня$$ $$СегодняДляЗанятия1$$, $$УслугаПерсональная_2$$, Фитнес плюс, * (выполнено)' | '$$УслугаПерсональная_2$$, $$УслугаПерсональная_2$$, Розничная цена' |
